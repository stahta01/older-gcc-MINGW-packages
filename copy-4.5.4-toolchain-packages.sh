...
cp -f ./mingw-w64-crt2-git/mingw-w64-i686-headers-git-2.0.6.r0.g06c5a4241-5-any.pkg.tar.zst ./packages/gcc4.5.4_toolchain_mingw_32_packages/
cp -f ./mingw-w64-crt2-git/mingw-w64-i686-crt-git-2.0.6.r0.g06c5a4241-5-any.pkg.tar.zst ./packages/gcc4.5.4_toolchain_mingw_32_packages/
