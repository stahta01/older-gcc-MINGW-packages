...
cp -f ./mingw-w64-headers9-git/mingw-w64-x86_64-headers-git-9.0.0.r32.gae63cde27-1-any.pkg.tar.zst ./packages/gcc10.3.0_toolchain_mingw_64_packages/
cp -f ./mingw-w64-crt9-git/mingw-w64-x86_64-crt-git-9.0.0.r32.gae63cde27-1-any.pkg.tar.zst ./packages/gcc10.3.0_toolchain_mingw_64_packages/
cp -f ./mingw-w64-winpthreads9-git/mingw-w64-x86_64-libwinpthread-git-9.0.0.r32.gae63cde27-1-any.pkg.tar.zst ./packages/gcc10.3.0_toolchain_mingw_64_packages/
...
cp -f ./mingw-w64-headers9-git/mingw-w64-i686-headers-git-9.0.0.r32.gae63cde27-1-any.pkg.tar.zst ./packages/gcc10.3.0_toolchain_mingw_32_packages/
cp -f ./mingw-w64-crt9-git/mingw-w64-i686-crt-git-9.0.0.r32.gae63cde27-1-any.pkg.tar.zst ./packages/gcc10.3.0_toolchain_mingw_32_packages/
cp -f ./mingw-w64-winpthreads9-git/mingw-w64-i686-libwinpthread-git-9.0.0.r32.gae63cde27-1-any.pkg.tar.zst ./packages/gcc10.3.0_toolchain_mingw_32_packages/
...
cp -f ./mingw-w64-headers9-git/mingw-w64-ucrt-x86_64-headers-git-9.0.0.r32.gae63cde27-1-any.pkg.tar.zst ./packages/gcc10.3.0_toolchain_mingw_UCRT64_packages/
cp -f ./mingw-w64-crt9-git/mingw-w64-ucrt-x86_64-crt-git-9.0.0.r32.gae63cde27-1-any.pkg.tar.zst ./packages/gcc10.3.0_toolchain_mingw_UCRT64_packages/
cp -f ./mingw-w64-winpthreads9-git/mingw-w64-ucrt-x86_64-libwinpthread-git-9.0.0.r32.gae63cde27-1-any.pkg.tar.zst ./packages/gcc10.3.0_toolchain_mingw_UCRT64_packages/
