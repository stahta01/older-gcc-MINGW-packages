...
cp -f ./mingw-w64-crt8-git/mingw-w64-x86_64-crt-git-8.0.2.r0.g368175526-1-any.pkg.tar.zst ./packages/gcc9.5.0_toolchain_mingw_64_packages/
cp -f ./mingw-w64-winpthreads8-git/mingw-w64-x86_64-libwinpthread-git-8.0.2.r0.g368175526-1-any.pkg.tar.zst ./packages/gcc9.5.0_toolchain_mingw_64_packages/
cp -f ./mingw-w64-winpthreads8-git/mingw-w64-x86_64-winpthreads-git-8.0.2.r0.g368175526-1-any.pkg.tar.zst ./packages/gcc9.5.0_toolchain_mingw_64_packages/
...
cp -f ./mingw-w64-crt8-git/mingw-w64-i686-crt-git-8.0.2.r0.g368175526-1-any.pkg.tar.zst ./packages/gcc9.5.0_toolchain_mingw_32_packages/
cp -f ./mingw-w64-winpthreads8-git/mingw-w64-i686-libwinpthread-git-8.0.2.r0.g368175526-1-any.pkg.tar.zst ./packages/gcc9.5.0_toolchain_mingw_32_packages/
cp -f ./mingw-w64-winpthreads8-git/mingw-w64-i686-winpthreads-git-8.0.2.r0.g368175526-1-any.pkg.tar.zst ./packages/gcc9.5.0_toolchain_mingw_32_packages/
...
cp -f ./mingw-w64-crt8-git/mingw-w64-ucrt-x86_64-crt-git-8.0.2.r0.g368175526-1-any.pkg.tar.zst ./packages/gcc9.5.0_toolchain_mingw_UCRT64_packages/
cp -f ./mingw-w64-winpthreads8-git/mingw-w64-ucrt-x86_64-libwinpthread-git-8.0.2.r0.g368175526-1-any.pkg.tar.zst ./packages/gcc9.5.0_toolchain_mingw_UCRT64_packages/
