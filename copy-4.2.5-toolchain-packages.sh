...
cp -f ./mingw-w64-gcc4.5-git/mingw-w64-i686-gcc-libs-git-4.5.4+d20120702.r42.c7.g41eccc86828f-5-any.pkg.tar.zst ./packages/gcc4.2.5_toolchain_mingw_32_packages/
