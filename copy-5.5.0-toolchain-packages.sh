...
cp -f ./mingw-w64-crt4-git/mingw-w64-x86_64-crt-git-4.0.6.r18.gae0e22cd1-1-any.pkg.tar.zst ./packages/gcc5.5.0_toolchain_mingw_64_packages/
cp -f ./mingw-w64-winpthreads4-git/mingw-w64-x86_64-libwinpthread-git-4.0.6.r18.gae0e22cd1-1-any.pkg.tar.zst ./packages/gcc5.5.0_toolchain_mingw_64_packages/
cp -f ./mingw-w64-winpthreads4-git/mingw-w64-x86_64-winpthreads-git-4.0.6.r18.gae0e22cd1-1-any.pkg.tar.zst ./packages/gcc5.5.0_toolchain_mingw_64_packages/
...
cp -f ./mingw-w64-crt4-git/mingw-w64-i686-crt-git-4.0.6.r18.gae0e22cd1-1-any.pkg.tar.zst ./packages/gcc5.5.0_toolchain_mingw_32_packages/
cp -f ./mingw-w64-winpthreads4-git/mingw-w64-i686-libwinpthread-git-4.0.6.r18.gae0e22cd1-1-any.pkg.tar.zst ./packages/gcc5.5.0_toolchain_mingw_32_packages/
cp -f ./mingw-w64-winpthreads4-git/mingw-w64-i686-winpthreads-git-4.0.6.r18.gae0e22cd1-1-any.pkg.tar.zst ./packages/gcc5.5.0_toolchain_mingw_32_packages/
