...
cp -f ./mingw-w64-crt10-git/mingw-w64-x86_64-crt-git-10.0.0.r184.gab72a4850-1-any.pkg.tar.zst ./packages/gcc12.3.0_toolchain_mingw_64_packages/
...
cp -f ./mingw-w64-crt10-git/mingw-w64-i686-crt-git-10.0.0.r184.gab72a4850-1-any.pkg.tar.zst ./packages/gcc12.3.0_toolchain_mingw_32_packages/
...
cp -f ./mingw-w64-crt10-git/mingw-w64-ucrt-x86_64-crt-git-10.0.0.r184.gab72a4850-1-any.pkg.tar.zst ./packages/gcc12.3.0_toolchain_mingw_UCRT64_packages/
